...
led_setup_t leds_black_with_teal_stripe[] = {
    { .hs = 0, .he = 15, .rs = 0, .re = 55, .gs = 0, .ge = 255, .bs = 0, .be = 200, .ef = EF_SCR_L },
    { .hs = 15, .he = 30, .rs = 55, .re = 0, .gs = 255, .ge = 0, .bs = 200, .be = 0, .ef = EF_SCR_L },
    { .end = 1 },
};

led_setup_t leds_black_with_teal_yellow_stripe[] = {
    { .hs = 0, .he = 15, .rs = 0, .re = 55, .gs = 0, .ge = 255, .bs = 0, .be = 200, .ef = EF_SCR_L },
    { .hs = 15, .he = 30, .rs = 55, .re = 255, .gs = 255, .ge = 247, .bs = 200, .be = 11, .ef = EF_SCR_L },
    { .hs = 30, .he = 45, .rs = 255, .re = 0, .gs = 247, .ge = 0, .bs = 11, .be = 0, .ef = EF_SCR_L },
    { .end = 1 },
};
...
void *led_setups[] = {
    leds_black_with_teal_yellow_stripe,
    leds_rainbow_s,
    leds_rainbow_ns,
    leds_teal_salmon,
    leds_yellow,
